    ...
    try:
        with open(file_path, 'r', encoding='utf-8') as f:
            ...
            return_dict{"response": True} # type: ignore
             return_dict{"message": "File Found and succesfully Read"} # type: ignore
            return_dict{"data":content} # type: ignore
            return return_dict
    except FileNotFoundError:
        return_dict{"response": False} # type: ignore
        return_dict{"message": f"Error: The file '{file_path}' was not found."} # type: ignore
        return_dict{"data":Null} # type: ignore
        return return_dict
    except Exception as e:
        return_dict{"response": False} # type: ignore
        return_dict{"message": f"An error occurred while reading the file: {e}"} # type: ignore
        return_dict{"data":Null} # type: ignore
        return return_dict